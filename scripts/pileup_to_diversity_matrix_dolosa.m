function pileup_to_diversity_matrix(fname_in,fname_out,refgenome, Phred_offset, RUN_ON_CLUSTER)
...
Phred_offset=int16(Phred_offset);
nts=int16('ATCGatcg');
indels=int16('+-');
numfields=39;
...
%Initialize
[ChrStarts,GenomeLength,ChromosomeIndicator]=genomestats(refgenome, RUN_ON_CLUSTER); %RUN_ON_CLUSTER
