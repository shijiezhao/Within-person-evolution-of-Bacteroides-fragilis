...
run_parallel_unix_commands_fast({'/opt/samtools/bin/samtools index aligned.sorted.bam; rm strain.pileup; rm -r ../../cutadapted; rm ../*.fastq; rm ../../*.fastq'},mini_q,Parallel,dirs);
